...
class SaveView extends MasterView {
  _parentEl = document.querySelector(".booked-container");
  _container = document.querySelector(".booking");
  _errorMessage = "You currently have no booked Destinations!";
